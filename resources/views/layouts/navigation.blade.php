            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('result.lookup')" :active="request()->routeIs('result.lookup')">
                            {{ __('Check Results') }}
                        </x-nav-link>
                        <x-nav-link :href="route('transcript.show')" :active="request()->routeIs('transcript.show')">
                            {{ __('Transcript') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('result.lookup')" :active="request()->routeIs('result.lookup')">
                    {{ __('Check Results') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('transcript.show')" :active="request()->routeIs('transcript.show')">
                    {{ __('Transcript') }}
                </x-responsive-nav-link>
            @endif
        </div>
